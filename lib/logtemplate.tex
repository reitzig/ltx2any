...
% error navigation.
\usepackage{xcolor,marginnote,xifthen}
\reversemarginpar
\newcounter{errornr}
\newcounter{errorref}
...
\newcommand{\error}{%
  ...
  % Error text itself
  {\color{red!80!black}\textbf{\textsc{Error}}}\hfill%
...
\newcommand{\logref}[1]{\vspace{-1em}\hfill{\footnotesize \texttt{log:#1}}}
\newenvironment{blockitem}{\begin{minipage}[t]{\linewidth}\leavevmode}{\end{minipage}}
\pagestyle{empty}
...
\hypersetup{breaklinks=true,
            ...
            linkcolor=$if(linkcolor)$$linkcolor$$else$red!80!black$endif$,
            pdfborder={0 0 0}}
