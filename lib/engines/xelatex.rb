...
Dependency.new('xelatex', :binary, [:engine, 'xelatex'], :essential) # TODO: refactor
...
module Chew
  module Engines
    ...
    class XeLaTeX < Engine
      ...
      def initialize
        @target_file = "#{ParameterManager.instance[:jobname]}.#{XeLaTeX.extension}"
